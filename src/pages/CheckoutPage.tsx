...
const paymentMethods: PaymentMethod[] = [
  {
    ...
    description: 'ادفع عند استلام الطلب - الدفع نقداً عند التوصيل',
    icon: '💵',
    popular: true
  },
  {
    id: 'moyasar',
    name: 'موياسار',
    description: 'الدفع الإلكتروني الآمن بالبطاقة',
    icon: '🔒'
  },
  {
    id: 'stripe',
              ...
              {selectedPaymentMethod === 'cod' && (
                <div className="payment-security-notice">
                  ...
                  <div className="payment-security-notice-text">
                    <p className="payment-security-notice-title">الدفع عند الاستلام</p>
                    <p>سيتم تحصيل المبلغ عند توصيل الطلب إليك. تأكد من وجود المبلغ النقدي المطلوب.</p>
                  </div>
                </div>
              )}
            </div>
